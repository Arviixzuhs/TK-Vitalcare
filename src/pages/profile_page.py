...
class ProfilePage(Page):
    def __init__(self, parent, user, *args, **kwargs):
        ...
        self.update_button = Button(
            self.frame, text="Actualizar perfil", command=self.update_profile
        )
        ...
        self.change_password_frame = LabelFrame(self, text="Cambiar contraseña")
        self.change_password_frame.grid(row=3, column=0, columnspan=2, pady=20, padx=20)

        # Input Password
        Label(self.change_password_frame, text="Contraseña: ").grid(
    ...
    def update_profile(self):
        ...
        if not name or not last_name:
            return self.message_1.config(text="Todos los campos son requeridos")
    ...
    def change_password(self):
        ...
        if not password:
            return self.message_2.config(text="Todos los campos son requeridos")
